<template>
  <div class="blog-list">
    <q-tabs v-model="tab" dense narrow-indicator align="left" no-caps class="blog-list__tabs">
      <q-tab name="all" label="Все" />
      <q-tab v-for="type in contentTypes" :key="type" :name="type" :label="contentTypeLabels[type]" />
    </q-tabs>
    ...
    <q-tab-panels v-model="tab" animated>
                  ...
                  <q-card-section horizontal>
                    ...
                    <div class="">
                      ...
                      <q-card-section class="row justify-end">
                        <q-btn class="events__main-card__button absolute-bottom-right q-mr-md q-mb-sm" no-caps flat>Подробнее</q-btn>
                      </q-card-section>
                    </div>
                  </q-card-section>
                </q-card>
                <q-card v-else-if="index <= 2" class="events__card" flat bordered>
                  <q-card-section class="events__card__section">
                    <q-card-section class="events__card__section">
                      <q-img class="events__card__img" :src="post.image" width="284px" height="250px" />
                    </q-card-section>
                    <div class="">
      ...
      <q-tab-panel v-for="type in contentTypes" :key="type" :name="type">
        <div class="row justify-center">
          <div class="events__container">
            <div class="q-pa-md row items-start q-gutter-sm">
              <template v-for="(post, index) in postByType[type]" :key="post.id">
                <q-card v-if="index === 0" class="events__main-card" flat bordered>
                  <q-card-section horizontal>
                    <q-card-section class="events__main-card__section">
                      <q-img class="" :src="post.image" width="219px" height="280px" />
